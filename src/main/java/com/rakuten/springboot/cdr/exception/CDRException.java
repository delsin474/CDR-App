...
import com.rakuten.springboot.cdr.config.PropertiesConfig;
...
public class CDRException {
    ...
    @Autowired
    public CDRException(PropertiesConfig propertiesConfig) {
        CDRException.propertiesConfig = propertiesConfig;
    }
